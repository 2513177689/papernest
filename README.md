...
当前版本：**v0.2.0 · 经典阅读排行榜**。主要界面为中文，适合个人研究与学习。无需模型密钥即可使用基础功能。
...
| 经典 | 100 篇带教材/官方文档依据的基础及延伸阅读；方向榜、全部榜、百分制阅读优先分与 S/A/B/C 等级；每榜最多 100 篇 |
...
- 经典清单包含 100 篇有来源依据的计算机与机器学习基础及教材延伸阅读。尚未自动爬取全网课程书单、综述或引用图来判定“经典”。
