...
export type Paper={id:string;title:string;authors:string[];abstract:string;published:string;source:string;url:string;pdf_url:string;pdf_file:string;pdf_hash:string;doi:string;arxiv_id:string;tags:string[];saved:boolean;status:string;feedback:string;collections:string[];classic:boolean;curation?:string;evidence:{label:string;url:string;type:string}[];summary?:Summary;deep_summary?:Summary;reasons?:string[];rank_score?:number;excluded?:string[];analysis?:{summary:string;reason:string;uncertain:string;concepts?:string[]};page_count?:number;pages?:{page:number;text:string}[];read_page?:number;scanned?:boolean;version?:string;pdf_version?:string};
